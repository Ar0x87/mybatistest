...
public class HotelController {
    ...
    public Integer putJ(@Valid @RequestBody StructureForPut reqLin) throws UnexistanceException, SQLException {
        log.debug("*-----------------------------------------------------------------------------------------*");
        log.debug("Request received and passed to the service.");
    ...
    public Integer patJ(@Valid @RequestBody StructureForPatch reqLin) throws EmptyBodyException, MisstargetException, SQLException {
        log.info("*-----------------------------------------------------------------------------------------*");
        log.debug("Request received and passed to the service.");
